...
#                if order.amount_total == sum(invoice_ids.mapped('amount_total')): 
#                     cancel_invoice = order.invoice_ids.filtered(lambda ai:ai.state=='cancel')
#                     for inv in cancel_invoice:
#                         cancel_inv_amount += inv.amount_untaxed
                total_amount = amount
